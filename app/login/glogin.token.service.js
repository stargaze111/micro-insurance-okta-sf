...
var GAuthenticationService = (function () {
    function GAuthenticationService(http, router) {
        this.http = http;
        this.router = router;
        this._tokenUrl = 'https://smsapigee-test.apigee.net/v4/insurance/staff/gauth/login';
        this.loggedIn = false;
        this.token = '';
        this.error = "";
        this.isAuthenticated = (localStorage.getItem("sms_access_token") != null) ? true : false;
    }
    GAuthenticationService.prototype.postTokenRequest = function (loginUserModel, clientId) {
...
//# sourceMappingURL=glogin.token.service.js.map